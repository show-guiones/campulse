    ...
    <>
      ...
      <div className="mob-sticky">
        ...
        <a href={AFFILIATE_URL} target="_blank" rel="noopener noreferrer"
          ...
          {isLive ? "Ver en vivo" : "Ver en Chaturbate"}
        </a>
      </div>
      ...
      <div className="mob-hero">
        ...
        <div className="mob-viewer-card">
          <div>
            <div className="mob-viewer-num">{viewers!=null ? viewers.toLocaleString("es") : "—"}</div>
      ...
      <a href={AFFILIATE_URL} target="_blank" rel="noopener noreferrer"
        ...
        <div>
          ...
          <div className={isLive?"mob-cta-sub":"mob-cta-sub-off"}>
            {isLive ? `${viewers?.toLocaleString("es")} espectadores · chaturbate.com` : "Estadísticas en tiempo real · chaturbate.com"}
          </div>
        </div>
      ...
      <div className="mob-metrics">
        <div className="mob-metric">
          <div className="mob-mval">{viewers!=null?viewers.toLocaleString("es"):"—"}</div>
      ...
      {isLive && (
        <div className="mob-embed-section">
          <div className="mob-embed-lbl"><span className="cmp-live-dot"/>En vivo · {viewers?.toLocaleString("es")} viewers</div>
