...
const LANG_VARIANTS = {
  ...
  portuguese:["portuguese","portugués","portugues","pt"],romanian:["romanian","rumano","româna","ro"],
  russian:["russian","ruso","???????","ru"],german:["german","alemán","deutsch","de"],
  french:["french","francés","français","fr"],italian:["italian","italiano","it"],
};
const LANG_NAMES = { spanish:"Español",english:"English",portuguese:"Português",romanian:"Româna",russian:"???????",german:"Deutsch",french:"Français",italian:"Italiano" };
